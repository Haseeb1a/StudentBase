  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: AppBarTitile(firstName: 'Stud', secondName: 'ents ')),
                    ...
                    child: Slidable(
                      endActionPane:
                        ...
                        SlidableAction(
                          ...
                          foregroundColor: AppColors().primarytheme,
                        ),
                        SlidableAction(
                          onPressed: (context) {
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          radius: 37,
                          backgroundImage:
                              NetworkImage(donorSnap.image.toString()),
                          backgroundColor: Colors.black,
                        ),
                        title: Row(
                          children: [
                        ...
                        trailing: Padding(
                          ...
                          child: Text(donorSnap.stand.toString(),
                              style: TextStyle(
